...
namespace AW
{
    internal class NativeMethods
    {
        ...
        [DllImport("aw.dll", CharSet = CharSet.Unicode, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("aw.dll", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_createW", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("aw.dll", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_stringW", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr aw_string(Attributes a);

        [DllImport("aw.dll", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_string_setW", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("aw.dll", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_enterW", CallingConvention = CallingConvention.Cdecl)]
        public static extern int aw_enter(string world);

        [DllImport("aw.dll", CharSet = CharSet.Unicode, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
        public static extern int aw_exit();

        [DllImport("aw.dll", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_sayW", CallingConvention = CallingConvention.Cdecl)]
        public static extern int aw_say(string message);

        [DllImport("aw.dll", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_whisperW", CallingConvention = CallingConvention.Cdecl)]
        public static extern int aw_whisper(int sessionId, string message);

        [DllImport("aw.dll", CharSet = CharSet.Unicode, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
        public static extern int aw_state_change();

        [DllImport("aw.dll", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_citizen_attributes_by_nameW", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("aw.dll", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_license_attributesW", CallingConvention = CallingConvention.Cdecl)]
        public static extern int aw_license_attributes(string name);

        [DllImport("aw.dll", CharSet = CharSet.Unicode, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
        public static extern int aw_license_change();

        [DllImport("aw.dll", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_license_deleteW", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("aw.dll", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_url_sendW", CallingConvention = CallingConvention.Cdecl)]
        public static extern int aw_url_send(int sessionId, string url, string target);

        [DllImport("aw.dll", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_url_clickW", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("aw.dll", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_world_attribute_setW", CallingConvention = CallingConvention.Cdecl)]
        public static extern int aw_world_attribute_set(int attribute, string value);

        [DllImport("aw.dll", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_world_attribute_getW", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("aw.dll", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_check_rightW", CallingConvention = CallingConvention.Cdecl)]
        public static extern bool aw_check_right(int citizen, string str);

        [DllImport("aw.dll", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_check_right_allW", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("aw.dll", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_server_adminW", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("aw.dll", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint="aw_avatar_locationW", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("aw.dll", CharSet = CharSet.Unicode, ExactSpelling = true, EntryPoint = "aw_say_channelW", CallingConvention = CallingConvention.Cdecl)]
